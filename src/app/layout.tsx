...
export const metadata: Metadata = {
  title: "Very Big Belly - Fine Dining Restaurant",
  description: "Experience culinary excellence at Very Big Belly. Exceptional cuisine, warm ambiance, and impeccable service. Reserve your table today.",
  keywords: "restaurant, fine dining, cuisine, reservations, gourmet, appetizers, main courses, desserts",
  metadataBase: new URL("https://verybigbelly.com"),
  alternates: {
    canonical: "https://verybigbelly.com"
  },
  openGraph: {
    title: "Very Big Belly - Fine Dining Restaurant",
    description: "Experience culinary excellence at Very Big Belly. Exceptional cuisine, warm ambiance, and impeccable service.",
    siteName: "Very Big Belly",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765460604111-svritom2.jpg",
      alt: "Very Big Belly Restaurant"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Very Big Belly - Fine Dining Restaurant",
    description: "Experience culinary excellence at Very Big Belly.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765460604111-svritom2.jpg"]
  },
  robots: {
    index: true,
    follow: true
